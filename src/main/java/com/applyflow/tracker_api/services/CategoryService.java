...
public class CategoryService {
        ...
        public List<Category> getAllCategories(Long userId) {
                return categoryRepository.findAllWithSkillsByUserId(userId);
        }

        @Transactional(readOnly = true)
        public Category getCategoryById(Long categoryId, Long userId) {
                return categoryRepository.findByIdAndUserIdWithSkills(categoryId, userId)
        ...
        public Category updateCategory(Long categoryId, Long userId, String name) {
                Category category = categoryRepository.findByIdAndUserIdWithSkills(categoryId, userId)
                                .orElseThrow(() -> new ResponseStatusException(
                                                HttpStatus.NOT_FOUND, "Category not found"));
