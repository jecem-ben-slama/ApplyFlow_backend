...
public class AuthController {
    ...
    public ApiResponse<UserDto> getCurrentUser() {
        ...
        User user = userRepository.findById(userId)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "User profile missing."));

        // 3. Map directly into the flat immutable record layout
        ...
        // 4. Return clean data completely free of nested collections
